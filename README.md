...
The goal is to help Java developers leverage the Java Zowe Client Software Development Kit (SDK) to build client applications and scripts that interface with the mainframe seamlessly. 
