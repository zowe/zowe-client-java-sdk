...
Thin JAR (recommended):  
    ...
    implementation group: 'org.zowe.client.java.sdk', name: 'zowe-client-java-sdk', version: '6.2.1'    

Fat JAR (with dependencies):  
  
    implementation group: 'org.zowe.client.java.sdk', name: 'zowe-client-java-sdk', version: '6.2.1', classifier: 'jar-with-dependencies'
