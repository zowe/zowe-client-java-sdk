...
Thin JAR (recommended):  
    ...
    implementation group: 'org.zowe.client.java.sdk', name: 'zowe-client-java-sdk', version: '6.0.2'    

Fat JAR (with dependencies):  
  
    implementation group: 'org.zowe.client.java.sdk', name: 'zowe-client-java-sdk', version: '6.0.2', classifier: 'jar-with-dependencies'
