...
Thin JAR (recommended):  
    ...
    implementation group: 'org.zowe.client.java.sdk', name: 'zowe-client-java-sdk', version: '7.0.0-RC5'    

Fat JAR (with dependencies):  
  
    implementation group: 'org.zowe.client.java.sdk', name: 'zowe-client-java-sdk', version: '7.0.0-RC5', classifier: 'jar-with-dependencies'
