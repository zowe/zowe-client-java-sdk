...
public class JobWaitInputData {
     ...
     * @author Frank Giordano
     */
    private JobWaitInputData(final JobWaitInputData.Builder builder) {
    ...
    public static class Builder {
         ...
         */
        public JobWaitInputData.Builder attempts(final int attempts) {
            this.attempts = attempts;
            return this;
        }
         ...
         * @return Builder object
         */
        public JobWaitInputData.Builder jobStatus(final JobStatus.Type jobStatus) {
            this.jobStatus = jobStatus;
            return this;
        }
         ...
         * @return Builder object
         */
        public JobWaitInputData.Builder lineLimit(final int lineLimit) {
            this.lineLimit = lineLimit;
            return this;
        }
         ...
         * @return Builder object
         */
        public JobWaitInputData.Builder watchDelay(final int watchDelay) {
            this.watchDelay = watchDelay;
            return this;
        }
         ...
         */
        public JobWaitInputData build() {
            return new JobWaitInputData(this);
        }
