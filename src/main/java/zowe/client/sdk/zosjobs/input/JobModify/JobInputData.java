...
public class JobInputData {
     ...
     * @author Nikunj Goyal
     */
    private JobInputData(final JobInputData.Builder builder) {
    ...
    public static class Builder {
         ...
         */
        public JobInputData.Builder version(final String version) {
         ...
         */
        public JobInputData build() {
            return new JobInputData(this);
        }
