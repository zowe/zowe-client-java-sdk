...
import zowe.client.sdk.zosjobs.input.JobModify.JobInputData;
...
public class JobCancelExp extends TstZosConnection {
    ...
    public static Response cancelCommonWithVersion(String version) {
        jobId = "xxx";
        jobName = "xxx";
        JobInputData params = new JobInputData.Builder(jobName, jobId).version(version).build();
        try {
    ...
    public static Response cancelCommon() {
        jobId = "xxx";
        jobName = "xxx";
        JobInputData params = new JobInputData.Builder(jobName, jobId).build();
        try {
            return new JobCancel(connection).cancelCommon(params);
        } catch (ZosmfRequestException e) {
            final String errMsg = Util.getResponsePhrase(e.getResponse());
...
public class JobGetExp extends TstZosConnection {
    ...
    public static void getSpoolContent(String prefix) {
        JobInputData params = new JobInputData.Builder("*").prefix(prefix).build();
        String[] output;
        try {
...
public class JobMonitorExp extends TstZosConnection {
    ...
    public static void monitorIsJobRunning() {
        ...
        JobWaitInputData monitorParams = new JobWaitInputData.Builder("XXX", "XXX").build();
        try {
