...
public class JobDelete {
    ...
    public Response delete(final String jobName, final String jobId, final String version) throws ZosmfRequestException {
        ...
        return deleteCommon(new JobInputData.Builder(jobName, jobId).version(version).build());
    }
    ...
    public Response deleteByJob(final Job job, final String version) throws ZosmfRequestException {
        ...
        return this.deleteCommon(new JobInputData.Builder(jobName, jobId).version(version).build());
    }
    ...
    public Response deleteCommon(final JobInputData params) throws ZosmfRequestException {
