...
public class JobCancel {
    ...
    public Response cancel(final String jobName, final String jobId, final String version) throws ZosmfRequestException {
        ...
        return this.cancelCommon(new JobInput.Builder(jobName, jobId).version(version).build());
    }
    ...
    public Response cancelCommon(final JobInput params) throws ZosmfRequestException {
