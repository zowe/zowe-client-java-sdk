...
public class JsonDeleteRequest extends ZoweRequest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JsonDeleteRequest.class);
    ...
    public JsonDeleteRequest(ZOSConnection connection) {
        super(connection, ZoweRequestType.DELETE_JSON);
    }
    ...
    public void setRequest(String url) throws Exception {
        ...
        request = new HttpDelete(Optional.ofNullable(url).orElseThrow(() -> new Exception("url not specified")));
        setup();
    }
