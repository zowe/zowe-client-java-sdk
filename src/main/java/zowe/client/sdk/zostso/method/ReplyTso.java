 ...
 * @version 5.0
 */
public class ReplyTso {

    private final ZosConnection connection;
    private ZosmfRequest request;

    /**
     * ReplyTso constructor
     *
     * @param connection for connection information, see ZosConnection object
     * @author Frank Giordano
     */
    public ReplyTso(final ZosConnection connection) {
        ValidateUtils.checkNullParameter(connection == null, "connection is null");
        this.connection = connection;
    }

    /**
     * Alternative ReplyTso constructor with ZoweRequest object. This is mainly used for internal code unit
     ...
     * @author Frank Giordano
     */
    ReplyTso(final ZosConnection connection, final ZosmfRequest request) {
        ValidateUtils.checkNullParameter(connection == null, "connection is null");
