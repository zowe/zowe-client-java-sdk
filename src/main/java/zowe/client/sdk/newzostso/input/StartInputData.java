 ...
 */
package zowe.client.sdk.newzostso.input;
...
public class StartInputData {
     ...
     * @author Frank Giordano
     */
    public StartInputData(final String logonProcedure, final String characterSet, final String codePage,
