...
public final class VariableGetResponse {
     ...
     */
    @JsonCreator
    public VariableGetResponse( @JsonProperty ("system-variable-list")
    final List<VariableResponse> systemVariableList, @JsonProperty("system-symbol-list")

    final List<VariableResponse> systemSymbolList) {
