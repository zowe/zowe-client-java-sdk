...
public final class WorkflowsConstants {
     ...
     */
    public static final String WORKFLOW_KEY_ILLEGAL_MSG =
            "workflowKey is either null or empty";

    /**
     * URI base workflow API
     */
    public static final String RESOURCE = "/workflow/rest/1.0/workflows";

    /**
     * URI base archived workflow API
     */
    public static final String RESOURCE_ARCHIVED =
            "/workflow/rest/1.0/archivedworkflows";
