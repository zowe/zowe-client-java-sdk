 ...
 * @version 4.0
 */
public class ChangeOwnerInputData {
     ...
     * @author James Kostrewski
     */
    public ChangeOwnerInputData(final ChangeOwnerInputData.Builder builder) {
    ...
    public static class Builder {
         ...
         */
        public ChangeOwnerInputData build() {
            return new ChangeOwnerInputData(this);
        }
