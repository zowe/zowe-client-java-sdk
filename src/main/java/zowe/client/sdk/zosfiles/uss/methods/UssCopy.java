...
public class UssCopy {
    ...
    public Response copy(final String fromPath, final String targetPath) throws ZosmfRequestException {
        return copyCommon(targetPath, new CopyInput.Builder().from(fromPath).build());
    }
    ...
    public Response copyCommon(final String targetPath, final CopyInput params) throws ZosmfRequestException {
