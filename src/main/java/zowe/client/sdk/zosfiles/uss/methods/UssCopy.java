...
public class UssCopy {
    ...
    public Response copy(final String fromPath, final String targetPath) throws ZosmfRequestException {
        return copyCommon(targetPath, new CopyInputData.Builder().from(fromPath).build());
    }
    ...
    public Response copyCommon(final String targetPath, final CopyInputData params) throws ZosmfRequestException {
