...
public class UssMount {
    ...
    public Response unmount(final String fileSystemName) throws ZosmfRequestException {
        return mountCommon(fileSystemName, new MountInputData.Builder().action(MountActionType.UNMOUNT).build());
    }
     ...
     * @author Frank Giordano
     */
    public Response mountCommon(final String fileSystemName, final MountInputData params) throws ZosmfRequestException {
