...
public class ListInputData {
     ...
     * @author Frank Giordano
     */
    public ListInputData(final ListInputData.Builder builder) {
    ...
    public static class Builder {
         ...
         * @return Builder this object
         */
        public ListInputData.Builder user(final String user) {
            this.user = user;
            return this;
        }
         ...
         */
        public ListInputData build() {
            return new ListInputData(this);
        }
