...
public class UssChangeOwner {
    ...
    public Response change(final String targetPath, final String owner) throws ZosmfRequestException {
        return changeCommon(targetPath, new ChangeOwnerInput.Builder().owner(owner).build());
    }
    ...
    public Response changeCommon(final String targetPath, final ChangeOwnerInput params) throws ZosmfRequestException {
