...
import zowe.client.sdk.zosfiles.uss.input.GetAclInputData;
...
public class UssGetAcl {
    ...
    public String get(final String targetPath, final boolean useCommas) throws ZosmfRequestException {
        final Response response = useCommas ?
                getAclCommon(targetPath, new GetAclInputData.Builder().usecommas(true).build()) :
                getAclCommon(targetPath, new GetAclInputData.Builder().build());
     ...
     * @author James Kostrewski
     */
    public Response getAclCommon(final String targetPath, final GetAclInputData params) throws ZosmfRequestException {
