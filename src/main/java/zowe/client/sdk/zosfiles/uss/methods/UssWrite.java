...
import zowe.client.sdk.zosfiles.uss.input.write.WriteInput;
...
public class UssWrite {
    ...
    public Response writeText(final String fileNamePath, final String content) throws ZosmfRequestException {
        return writeCommon(fileNamePath, new WriteInput.Builder().textContent(content).build());
    }
    ...
    public Response writeBinary(final String fileNamePath, final byte[] content) throws ZosmfRequestException {
        return writeCommon(fileNamePath, new WriteInput.Builder().binaryContent(content).binary(true).build());
    }
     ...
     * @author Frank Giordano
     */
    public Response writeCommon(final String fileNamePath, final WriteInput params) throws ZosmfRequestException {
