...
public class UssCreate {
    ...
    public Response create(final String targetPath, final CreateInput params) throws ZosmfRequestException {
    ...
    public Response createZfs(String fileSystemName) throws ZosmfRequestException {
        return createZfsCommon(fileSystemName, new CreateZfsInput.Builder(10).cylsSec(2).timeout(20).build());
    }
     ...
     * @author Frank Giordano
     */
    public Response createZfsCommon(String fileSystemName, CreateZfsInput params) throws ZosmfRequestException {
