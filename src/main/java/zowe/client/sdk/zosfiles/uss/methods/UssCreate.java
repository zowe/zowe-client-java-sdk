...
public class UssCreate {
    ...
    public Response create(final String targetPath, final CreateInputData params) throws ZosmfRequestException {
    ...
    public Response createZfs(String fileSystemName) throws ZosmfRequestException {
        return createZfsCommon(fileSystemName, new CreateZfsInputData.Builder(10).cylsSec(2).timeout(20).build());
    }
     ...
     * @author Frank Giordano
     */
    public Response createZfsCommon(String fileSystemName, CreateZfsInputData params) throws ZosmfRequestException {
