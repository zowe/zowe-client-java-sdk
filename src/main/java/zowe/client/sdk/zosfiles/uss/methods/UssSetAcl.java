...
import zowe.client.sdk.zosfiles.uss.input.SetAclInputData;
...
public class UssSetAcl {
    ...
    public Response set(final String targetPath, final String value) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInputData.Builder().setSet(value).build());
    }
    ...
    public Response modify(final String targetPath, final String value) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInputData.Builder().setModify(value).build());
    }
    ...
    public Response delete(final String targetPath, final String value) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInputData.Builder().setDelete(value).build());
    }
    ...
    public Response deleteByType(final String targetPath, final DeleteAclType deleteType) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInputData.Builder().setDeleteType(deleteType).build());
    }
     ...
     * @author James Kostrewski
     */
    public Response setAclCommon(final String targetPath, final SetAclInputData params) throws ZosmfRequestException {
