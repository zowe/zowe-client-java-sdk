...
import zowe.client.sdk.zosfiles.uss.input.set.SetAclInput;
...
public class UssSetAcl {
    ...
    public Response set(final String targetPath, final String value) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInput.Builder().setSet(value).build());
    }
    ...
    public Response modify(final String targetPath, final String value) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInput.Builder().setModify(value).build());
    }
    ...
    public Response delete(final String targetPath, final String value) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInput.Builder().setDelete(value).build());
    }
    ...
    public Response deleteByType(final String targetPath, final DeleteAclType deleteType) throws ZosmfRequestException {
        return setAclCommon(targetPath, new SetAclInput.Builder().setDeleteType(deleteType).build());
    }
     ...
     * @author James Kostrewski
     */
    public Response setAclCommon(final String targetPath, final SetAclInput params) throws ZosmfRequestException {
