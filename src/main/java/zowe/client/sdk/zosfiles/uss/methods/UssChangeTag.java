...
import zowe.client.sdk.zosfiles.uss.input.change.ChangeTagInput;
...
public class UssChangeTag {
    ...
    public Response binary(final String fileNamePath) throws ZosmfRequestException {
        return changeCommon(fileNamePath, new ChangeTagInput.Builder()
    ...
    public Response remove(final String fileNamePath) throws ZosmfRequestException {
        return changeCommon(fileNamePath, new ChangeTagInput.Builder().action(ChangeTagAction.REMOVE).build());
    }
    ...
    public Response get(final String fileNamePath) throws ZosmfRequestException {
        return changeCommon(fileNamePath, new ChangeTagInput.Builder().action(ChangeTagAction.LIST).build());
    }
     ...
     * @author James Kostrewski
     */
    public Response changeCommon(final String fileNamePath, final ChangeTagInput params) throws ZosmfRequestException {
        ValidateUtils.checkIllegalParameter(fileNamePath, "fileNamePath");
