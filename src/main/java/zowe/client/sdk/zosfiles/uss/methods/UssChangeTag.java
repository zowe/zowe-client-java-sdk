...
public class UssChangeTag {
    ...
    public Response binary(final String fileNamePath) throws ZosmfRequestException {
        return changeCommon(fileNamePath, new ChangeTagInputData.Builder()
    ...
    public Response remove(final String fileNamePath) throws ZosmfRequestException {
        return changeCommon(fileNamePath, new ChangeTagInputData.Builder().action(ChangeTagAction.REMOVE).build());
    }
    ...
    public Response get(final String fileNamePath) throws ZosmfRequestException {
        return changeCommon(fileNamePath, new ChangeTagInputData.Builder().action(ChangeTagAction.LIST).build());
    }
     ...
     * @author James Kostrewski
     */
    public Response changeCommon(final String fileNamePath, final ChangeTagInputData params) throws ZosmfRequestException {
        ValidateUtils.checkIllegalParameter(fileNamePath, "fileNamePath");
