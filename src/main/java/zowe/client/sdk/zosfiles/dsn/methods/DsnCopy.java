...
public class DsnCopy {
    ...
    public Response copy(final String fromDataSetName, final String toDataSetName, final boolean replace,
        ...
        return copyCommon(new CopyInputData.Builder()
     ...
     * @author Frank Giordano
     */
    public Response copyCommon(final CopyInputData params) throws ZosmfRequestException {
     ...
     * @author Frank Giordano
     */
    private String setUrl(final CopyInputData params) {
     ...
     * @author Frank Giordano
     */
    private Map<String, Object> setFromDataSetMapValues(final CopyInputData params) {
