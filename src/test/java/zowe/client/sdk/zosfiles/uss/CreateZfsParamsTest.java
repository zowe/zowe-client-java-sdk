...
public class CreateZfsParamsTest {
    ...
    public void tstCreateZfsParamsValueCheckSuccess() {
        CreateZfsInputData createZfsParams = new CreateZfsInputData.Builder(10).build();
    ...
    public void tstCreateZfsParamsNullValueFailure() {
        ...
        try {
            new CreateZfsInputData.Builder(null).build();
        } catch (Exception e) {
            isException = true;
        }
    ...
    public void tstCreateZfsParamsZeroValueMessageFailure() {
        String errMsg = null;
        try {
            new CreateZfsInputData.Builder(0).build();
        } catch (Exception e) {
            errMsg = e.getMessage();
        }
    ...
    public void tstCreateZfsParamsNegativeValueMessageFailure() {
        String errMsg = null;
        try {
            new CreateZfsInputData.Builder(-1).build();
        } catch (Exception e) {
            errMsg = e.getMessage();
        }
        assertEquals("specify cylsPri greater than 0", errMsg);
