...
public class AuthTypeTest {
    ...
    @Test
    public void tstEnumValuesSuccess() {
    ...
    @Test
    public void tstEnumValuesExistSuccess() {
    ...
    @Test
    public void tstEnumValueOfSuccess() {
    ...
    @Test
    public void tstEnumToStringSuccess() {
    ...
    @Test
    public void tstInvalidValueOfFailure() {
